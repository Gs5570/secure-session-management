...
export default function Login(){
    ...
    */
    ...
    const onSubmit = async(loginData)=>{ 
        await setLoggedInUser((prevState)=>{ return{...prevState, username:loginData.username, password:loginData.password}})
    ...
    return(
        <div>
            <form >
                <h1>Welcome</h1>
                <span><Link to ="/adminPage">Admin</Link></span>
                ...
                <div className="buttons-container">
                    ...
                    <button 
                        type="button" 
                        onClick={redirectToRegister}>Register
                    </button>
                </div>
